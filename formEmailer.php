...
//          CHANGE THE FOLLOWING INFORMATION TO SEND EMAIL FOR YOU //  
	...
	$toEmail = "nderrb@gmail.com";		//CHANGE within the quotes. Place email address where you wish to send the form data. 
										//Use your DMACC email address for testing. 
										//Example: $toEmail = "jhgullion@dmacc.edu";		
	
	$subject = "Form Emailer - Hogwarts";	//CHANGE within the quotes. Place your own message.  For the assignment use "WDV101 Email Example" 
